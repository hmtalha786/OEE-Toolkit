...
char *myStrings[] = {"d1.txt", "d2.txt", "d3.txt", "d4.txt", "d5.txt", "d6.txt", "d7.txt", "d8.txt", "d9.txt", "d10.txt" };
...
void setup() {
  ...
  if (SD.begin(53)) { 
    ...
    delay(100);
    for (int i = 0; i < 10; i++) {
      Serial.print("deleting all files");
...
void write_to_sd(){
  ...
  // Set the current sd card file in use
  Set_Current_File();
...
void Send_SD_Card_Data() {
  if (SD.begin(53)) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      Serial.println(String(myStrings[i]));
      data_file = SD.open(myStrings[i]);
      delay(100);
      if (data_file) { 
        Serial.print("{\"values\":[");
...
void Set_Current_File(){
  if ( ( pack_count > 0 ) && ( pack_count < 31 ) ) { fileToWrite = myStrings[0]; }
  if ( ( pack_count > 30 ) && ( pack_count < 61 ) ){ fileToWrite = myStrings[1]; }
  if ( ( pack_count > 60 ) && ( pack_count < 91 ) ){ fileToWrite = myStrings[2]; }
  if ( ( pack_count > 90 ) && ( pack_count < 121 ) ){ fileToWrite = myStrings[3]; }
  if ( ( pack_count > 120 ) && ( pack_count < 151 ) ){ fileToWrite = myStrings[4]; }
  if ( ( pack_count > 150 ) && ( pack_count < 181 ) ){ fileToWrite = myStrings[5]; }
  if ( ( pack_count > 180 ) && ( pack_count < 211 ) ){ fileToWrite = myStrings[6]; }
  if ( ( pack_count > 210 ) && ( pack_count < 241 ) ){ fileToWrite = myStrings[7]; }
  if ( ( pack_count > 240 ) && ( pack_count < 271 ) ){ fileToWrite = myStrings[8]; }
  if ( ( pack_count > 270 ) && ( pack_count < 301 ) ){ fileToWrite = myStrings[9]; }
  if ( ( pack_count > 300 ) && ( pack_count < 330 ) ){ fileToWrite = myStrings[10];}
}
