...
char linkk[100] = "https://procheck-prod.azure-devices.net/devices/";
char linkik[60] = "/messages/events?api-version=2018-06-30";

char SASFirst[180] = "SharedAccessSignature sr=procheck-prod.azure-devices.net%2Fdevices%2F";
char SASMid[6] = "&sig=";
...
void setup() {
  ...
  if (chkok == "1")
  {
    ...
    httpSAS.begin("https://procheckprodfunctions.azurewebsites.net/api/GetSasToken?code=4ji8Wv3sHFDHRaoGgcjhzZos6IaWZmwgdUW2POuVUtBXRBY5%2F0MbSw%3D%3D"); // Special HTTP Endpoint for SAS token Generation
