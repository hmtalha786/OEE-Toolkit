...
uint16_t aOutputs[10];
uint16_t analogInputs[numAnalogInputs];
uint16_t analogOutputs[numAnalogInputs];
...
void setup() {
  ...
  modbus.setHoldingRegisters(aOutputs, 10);
...
//  }
  ...
  digitalWrite(1, digitalOutputs[0]);
  digitalWrite(1, digitalOutputs[1]);
  digitalWrite(1, digitalOutputs[2]);
  digitalWrite(1, digitalOutputs[3]);
  digitalWrite(1, digitalOutputs[4]);
  
//  for (int i = 0; i < numAnalogOutputs; ++i) {
//    analogWrite(analogOutputsPins[i], analogOutputs[i]);
//  }

//  analogWrite(345, analogOutputs[0]);
 // analogWrite(678, analogOutputs[1]);
  //analogWrite(910, analogOutputs[2]);
