...
void loop() {
  ...
  if ( millis() >= timer ) {
    ...
    if (isHubConnect && Esp32MQTTClient_SendEvent(buff)) {
      ...
      /* Blink RGB Red */
      digitalWrite(32, 1);   leds[0] = CRGB::Red;    FastLED.show();  delay(300);
      digitalWrite(32, 0);   leds[0] = CRGB::Black;  FastLED.show();
      
      delay(300);

      /* Blink RGB Green Led */
      digitalWrite(15, 1);   leds[0] = CRGB::Green;  FastLED.show();  delay(300);
      digitalWrite(15, 0);   leds[0] = CRGB::Black;  FastLED.show();
      ...
      digitalWrite(33, 1);   leds[0] = CRGB::Blue;   FastLED.show();  delay(300);
      digitalWrite(33, 0);   leds[0] = CRGB::Black;  FastLED.show();
...
void Connect_To_WiFi(const char * ssid, const char * pwd) {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    ...
    delay(500);
    Serial.print(".");
    if ( ( millis() - WiFi_Time_Check ) > 300000 ) { ESP.restart(); }
  }
