...
int pack_num = 0;                // JSON Packet Count Number 

int pack_count = 0;              // JSON Packet Storage Counter

int pack_limit = 60;             // JSON Packet Storage Limit

/*============================================================================================================================================================================*/

unsigned long timer = 30000;     // 30 second - JSON Packet Sending time Counter

unsigned long DT = 33000;        // Downtime Value i.e. 33 Seconds

/*============================================================================================================================================================================*/

int SS1 = 0;                     // Sensor`s Status Bits ( 0 => ON , 1 => OFF )
int PS1 = 0;                     // Sensor 1, 3, 5 Previous Status Bit

unsigned long DTS1 = 0;          // Sensor`s Down Time Stamps for continuous low input 
unsigned long CTS1 = 0;          // Sensor`s Continuous Time Stamps for continuous high input 

int S1 = 0;                      // Sensor`s Input Pin Values
int P1 = 0;                      // Sensor`s Input Pin Previous Values

unsigned long count1 = 0;        // Sensor`s Count Values 
...
void loop() {
  ...
  if ( PS1 != SS1 ) { timer = millis()+300000UL;  write_to_sd();  PS1 = SS1; }

  // JSON Packet Sent after every 5 min ....................................................
  if ( millis() >= timer ) { timer = millis()+300000UL; write_to_sd(); }
